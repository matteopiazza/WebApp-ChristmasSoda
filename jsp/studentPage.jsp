...
<html>
  ...
  <body>
	...
	<div class="topnav">
	  ...
	  <a href="${pageContext.request.contextPath}/studentUpdates"
       style="background-color: #ddd; color:black;">student</a>
    ...
    <div class="row">
          <div class="leftcolumn">
            <div class="card">
              <h1>Student Updates!</h2>
              <h3>Join us September 8, 1880</h5>
              <div class="fakeimg">
                  <img src="https://specials-images.forbesimg.com/imageserve/887132594/960x0.jpg?fit=scale" width="800px">
              </div>
              <p>Secret News</p>
