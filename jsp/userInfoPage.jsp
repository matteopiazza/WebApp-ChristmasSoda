...
<html>
	<head>
		<meta charset="UTF-8">
		<title>CSU - Christmas Soda University - My Account</title>
    <style>
        * {
	...
	<div class="topnav">
	  ...
	  <a href="${pageContext.request.contextPath}/userInfo"
       style="background-color: #ddd; color:black; float:right;">my account</a>
	</div>

    <div class="content">

    		<h2>Hello: ${loginedUser.fullName}</h2>

    		<h3>User Name: <b>${loginedUser.userName}</b>
    		<br />
    		Faculty: ${loginedUser.faculty} <br /></h3>
    		<br>
    		<br>

    		<form method="POST" action="${pageContext.request.contextPath}/logout">
    		<button class="button" style="vertical-align:middle"
    				value="submit"><span>Logout</span></button>
